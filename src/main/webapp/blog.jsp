...
<head>
   ...
   <!-- CSS -->
   <link href="resources/vendor/bootstrap-3.3.2/dist/css/bootstrap.min.css"        property='stylesheet' rel="stylesheet" type="text/css" media="screen"/>   
   <link href="resources/vendor/fontawesome/css/font-awesome.min.css"   property='stylesheet' rel="stylesheet" type="text/css" media="screen"/>   
   <link href="resources/vendor/flaticons/flaticon.css"                 property='stylesheet' rel="stylesheet" type="text/css" media="screen"/>   
   <link href="resources/vendor/hover/css/hover-min.css"                property='stylesheet' rel="stylesheet" type="text/css" media="screen"/>   
      ...
      <div class="row nopadding ident e-bg-light-texture">
         ...
         <div class="col-md-7 col-lg-8 vc-name nopadding">
            ...
            <div class="row nopadding name">
               <div class="col-md-10 name-title"><h2 class="font-accident-two-light uppercase">Samuel Anderson</h2></div>
            ...
            <div id="posts" class="row popup-container">
                     ...
                     <div class="item-wrap">
                        <figure class="">
                           <div class="popup-call">
                              <a href="resources/custom/images/blog/01.jpg" class="gallery-item"><i class="flaticon-arrows-4"></i></a>
                           </div>
                           <img src="resources/custom/images/blog/thumbs/01.jpg" class="img-responsive" alt="img11"/>
                           <figcaption>
                  ...
                  <div class="grid-item grid-sizer branding col-md-4 col-sm-6">
                     <div class="item-wrap">
                        <figure class="">
                           <div class="popup-call">
                              <a href="resources/custom/images/blog/02.jpg" class="gallery-item"><i class="flaticon-arrows-4"></i></a>
                           </div>
                           <img src="resources/custom/images/blog/thumbs/02.jpg" class="img-responsive" alt="img03"/>
                           <figcaption>
                              <div class="post-meta"><span>by <a href="#!">Sam Anderson</a>,</span> <span>March 16, 2015</span></div>
                              <div class="post-header">
                  ...
                  <div class="grid-item branding col-md-4 col-sm-6">
                     <div class="item-wrap">
                        <figure class="">
                           <div class="popup-call">
                              <a href="resources/custom/images/blog/03.jpg" class="gallery-item"><i class="flaticon-arrows-4"></i></a>
                           </div>
                           <img src="resources/custom/images/blog/thumbs/03.jpg" class="img-responsive" alt="img11"/>
                           <figcaption>
                              <div class="post-meta"><span>by <a href="#!">Sam Anderson</a>,</span> <span>March 16, 2015</span></div>
                              <div class="post-header">
                  ...
                  <div class="grid-item branding design col-md-4 col-sm-6">
                     <div class="item-wrap">
                        <figure class="">
                           <div class="popup-call">
                              <a href="resources/custom/images/blog/04.jpg" class="gallery-item"><i class="flaticon-arrows-4"></i></a>
                           </div>
                           <img src="resources/custom/images/blog/thumbs/04.jpg" class="img-responsive" alt="img03"/>
                           <figcaption>
                              <div class="post-meta"><span>by <a href="#!">Sam Anderson</a>,</span> <span>March 16, 2015</span></div>
                              <div class="post-header">
                  ...
                  <div class="grid-item branding col-md-4 col-sm-6">
                     <div class="item-wrap">
                        <figure class="">
                           <div class="popup-call">
                              <a href="resources/custom/images/blog/05.jpg" class="gallery-item"><i class="flaticon-arrows-4"></i></a>
                           </div>
                           <img src="resources/custom/images/blog/thumbs/05.jpg" class="img-responsive" alt="img11"/>
                           <figcaption>
                              <div class="post-meta"><span>by <a href="#!">Sam Anderson</a>,</span> <span>March 16, 2015</span></div>
                              <div class="post-header">
                  ...
                  <div class="grid-item design col-md-4 col-sm-6">
                     <div class="item-wrap">
                        <figure class="">
                           <div class="popup-call">
                              <a href="resources/custom/images/blog/06.jpg" class="gallery-item"><i class="flaticon-arrows-4"></i></a>
                           </div>
                           <img src="resources/custom/images/blog/thumbs/06.jpg" class="img-responsive" alt="img03"/>
                           <figcaption>
                              <div class="post-meta"><span>by <a href="#!">Sam Anderson</a>,</span> <span>March 16, 2015</span></div>
                              <div class="post-header">
                  ...
                  <div class="grid-item design col-md-4 col-sm-6">
                     <div class="item-wrap">
                        <figure class="">
                           <div class="popup-call">
                              <a href="resources/custom/images/blog/07.jpg" class="gallery-item"><i class="flaticon-arrows-4"></i></a>
                           </div>
                           <img src="resources/custom/images/blog/thumbs/07.jpg" class="img-responsive" alt="img03"/>
                           <figcaption>
                              <div class="post-meta"><span>by <a href="#!">Sam Anderson</a>,</span> <span>March 16, 2015</span></div>
                              <div class="post-header">
                  ...
                  <div class="grid-item branding design col-md-4 col-sm-6">
                     <div class="item-wrap">
                        <figure class="">
                           <div class="popup-call">
                              <a href="resources/custom/images/blog/08.jpg" class="gallery-item"><i class="flaticon-arrows-4"></i></a>
                           </div>
                           <img src="resources/custom/images/blog/thumbs/08.jpg" class="img-responsive" alt="img03"/>
                           <figcaption>
                              <div class="post-meta"><span>by <a href="#!">Sam Anderson</a>,</span> <span>March 16, 2015</span></div>
                              <div class="post-header">
...
<footer class="padding-50 e-bg-light-texture">
   <div class="container-fluid nopadding">
      <div class="row wow fadeInDown" data-wow-delay=".2s" data-wow-offset="10">
         <div class="col-md-3">
            <h4 class="font-accident-two-normal uppercase">Samuel Anderson</h4>
